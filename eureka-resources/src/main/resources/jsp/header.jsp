<%@ page language="java" 
  import="java.lang.String,java.util.*,com.netflix.config.*,com.netflix.eureka.*,com.netflix.eureka.registry.*,com.netflix.eureka.resources.*,com.netflix.appinfo.*,com.netflix.eureka.util.*" pageEncoding="UTF-8" %>
